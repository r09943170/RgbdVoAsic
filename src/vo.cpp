...
const double max_value_6 = pow(2.0, 127); 
                       ...
                       Mat& debug) //pylin
{
    ...
    // pylin↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
    int test_valid = 1;
    ifstream if_0("./result/debug_check_proj_d1_u_r_SW.txt");
    bool check_near_0to1 = if_0.good();
    ifstream if_1("./result/debug_check_near_1to2.txt");
    bool check_near_1to2 = if_1.good();
    if (check_near_0to1 == 0) {
        // ofstream f_Corr_u0  ("./debug_testing_data/SW_debug_Corr_u0.txt");
        // ofstream f_Corr_v0  ("./debug_testing_data/SW_debug_Corr_v0.txt");
        // ofstream f_Corr_d0  ("./debug_testing_data/SW_debug_Corr_d0.txt");
        // ofstream f_Corr_u1  ("./debug_testing_data/SW_debug_Corr_u1.txt");
        // ofstream f_Corr_v1  ("./debug_testing_data/SW_debug_Corr_v1.txt");
        // ofstream f_Corr_d1  ("./debug_testing_data/SW_debug_Corr_d1.txt");
        // ofstream f_Corr_n1_x("./debug_testing_data/SW_debug_Corr_n1_x.txt");
        // ofstream f_Corr_n1_y("./debug_testing_data/SW_debug_Corr_n1_y.txt");
        // ofstream f_Corr_n1_z("./debug_testing_data/SW_debug_Corr_n1_z.txt");
    int store_index = 32;
    int load_v_origin = 0;
                ...
                if(tp1_z > 0)
                {
                    ...
                    if(r.contains(Point(u0,v0))) //查看rect有沒有包含Point(u0, v0) -> 確認v0沒有超出範圍(480)
                    {
                        ...
                        if(validMask0.at<uchar>(v0, u0) && std::abs(tp1_z - trunc1(d0*MUL)) <= trunc1(maxDepthDiff*MUL) && std::abs(v1 - v0) <= maxLineDiff){
                            // f_Corr_u0 << long(u1) << endl; //match_u0
                            // f_Corr_v0 << long(v1) << endl; //match_v0
                            // f_Corr_d0 << long(d1) << endl; //match_d0
                            // f_Corr_u1 << long(u0) << endl; //match_u1
                            // f_Corr_v1 << long(v0) << endl; //match_v1
                            // f_Corr_d1 << long(d0) << endl; //match_d1
                            
                            // f_Corr_n1_x << long(normal0.at<Vec3d>(v0,u0)[0]) << endl; //match_n1_x
                            // f_Corr_n1_y << long(normal0.at<Vec3d>(v0,u0)[1]) << endl; //match_n1_y
                            // f_Corr_n1_z << long(normal0.at<Vec3d>(v0,u0)[2]) << endl; //match_n1_z
...
void calcRgbdLsmMatrices(const Mat& image0, //src
                         ...
                         Mat& AtA, Mat& AtB, 
                         std::vector<std::vector<long>>& AtA_vec, 
                         std::vector<long>& AtB_vec,
                         ...
                         Mat sigma_debug)
{
    ...
    // cout << "sigma_rgbd = " << sigma << endl;
    long tmp;
    tmp = long(sigma_debug.at<double>(1,1));
    sigma_debug.at<double>(1,1) = sigma;
    if (tmp != 0 ){
        sigma = tmp;
    }
    ...
    ifstream if_1("./debug_testing_data/debug_check_dI_dx_SW.txt");
    bool check_if_1 = if_1.good();
    if (check_if_1 == 0) {
        // ofstream f_Corr_dI_dx("./debug_testing_data/SW_debug_Corr_dI_dx.txt");
        // ofstream f_Corr_dI_dy("./debug_testing_data/SW_debug_Corr_dI_dy.txt");
        // ofstream f_Corr_data0("./debug_testing_data/SW_debug_Corr_data0.txt");
        // ofstream f_Corr_data1("./debug_testing_data/SW_debug_Corr_data1.txt");

    // ofstream of_tmp_v0_tmp("./debug_check_tmp_v0_tmp_SW.txt");
    // ofstream of_tmp_v1_tmp("./debug_check_tmp_v1_tmp_SW.txt");
    // ofstream of_zw("./debug_check_zw_SW.txt");

    // ofstream of_tp0_x("./debug_check_tp0_x_SW.txt");
    // ofstream of_tp0_y("./debug_check_tp0_y_SW.txt");
    // ofstream of_tp0_z("./debug_check_tp0_z_SW.txt");
    // ofstream of_tmp_v0("./debug_check_tmp_v0_SW.txt");
    // ofstream of_tmp_v1("./debug_check_tmp_v1_SW.txt");
    // ofstream of_tmp_v2("./debug_check_tmp_v2_SW.txt");

    // ofstream of_tmp_v2_1("./debug_check_tmp_v2_1_SW.txt");
    // ofstream of_tmp_v2_2("./debug_check_tmp_v2_2_SW.txt");
    // ofstream of_tmp_v2_tmp_w("./debug_check_tmp_v2_tmp_w_SW.txt");

    // ofstream of_A0("./debug_check_A0_SW.txt");
    // ofstream of_A1("./debug_check_A1_SW.txt");
    // ofstream of_A2("./debug_check_A2_SW.txt");
    // ofstream of_A3("./debug_check_A3_SW.txt");
    // ofstream of_A4("./debug_check_A4_SW.txt");
    // ofstream of_A5("./debug_check_A5_SW.txt");
    // ofstream of_diff_div_w("./debug_check_diff_div_w_SW.txt");

    // ofstream of_diff("./debug_check_diff_SW.txt");
    // ofstream of_w("./debug_check_w_SW.txt");
    ...
    for(int correspIndex = 0; correspIndex < corresps.rows; correspIndex++)
    {
        ...
        //  f_Corr_dI_dx << dI_dx1.at<short int>(v1,u1) << endl;
        //  f_Corr_dI_dy << dI_dy1.at<short int>(v1,u1) << endl;
        //  f_Corr_data0 << static_cast<int>(image0.at<uchar>(v0,u0)) << endl;
        //  f_Corr_data1 << static_cast<int>(image1.at<uchar>(v1,u1)) << endl;
        ...
        //  of_diff << long(diffs_ptr[correspIndex]) << endl;
        //  of_w << long(w_origin) << endl;

        //  of_tmp_v0_tmp << long(dI_dx1.at<short int>(v1,u1) * trunc1(fx * MUL)) << endl;
        //  of_tmp_v1_tmp << long(dI_dy1.at<short int>(v1,u1) * trunc1(fy * MUL)) << endl;
        //  of_zw << long(tp0.z*w_origin) << endl;

        // of_test1 << 1/(8*tp0.z*w_origin) << endl;
        // of_test2 << invzw << endl;

         double tmp_v2 = trunc1(-(tmp_v0 * tp0.x + tmp_v1 * tp0.y) * invz);
         mp::cpp_int tmp_v0_mp(tmp_v0);
         mp::cpp_int tmp_v1_mp(tmp_v1);
         mp::cpp_int tmp_v2_mp;
         mp::cpp_int tp0_x_mp(tp0.x);
         mp::cpp_int tp0_y_mp(tp0.y);
         mp::cpp_int tp0_z_mp(tp0.z);
         mp::cpp_int A_mp[6];
         mp::cpp_int r1, r2;
         tmp_v2_mp = -(tmp_v0_mp * tp0_x_mp + tmp_v1_mp * tp0_y_mp) / tp0_z_mp;

        //  of_tmp_v2_1 << tmp_v0_mp * tp0_x_mp << endl;
        //  of_tmp_v2_2 << tmp_v1_mp * tp0_y_mp << endl;
        //  of_tmp_v2_tmp_w << -(tmp_v0_mp * tp0_x_mp + tmp_v1_mp * tp0_y_mp) << endl;

        //  of_tp0_x << long(tp0.x) << endl;
        //  of_tp0_y << long(tp0.y) << endl;
        //  of_tp0_z << long(tp0.z) << endl;
        //  of_tmp_v0 << long(tmp_v0) << endl;
        //  of_tmp_v1 << long(tmp_v1) << endl;
        //  of_tmp_v2 << long(tmp_v2) << endl;
        ...
        //  A_ptr[2] = trunc1((-tp0.y * tmp_v0 + tp0.x * tmp_v1) / MUL);
         A_mp[0] = (-tp0_z_mp * tmp_v1_mp + tp0_y_mp * tmp_v2_mp) >> 24;
         A_mp[1] = ( tp0_z_mp * tmp_v0_mp - tp0_x_mp * tmp_v2_mp) >> 24;
         A_mp[2] = (-tp0_y_mp * tmp_v0_mp + tp0_x_mp * tmp_v1_mp) >> 24;
         A_mp[3] = mp::cpp_int(tmp_v0);
         A_mp[4] = mp::cpp_int(tmp_v1);
         A_mp[5] = mp::cpp_int(tmp_v2);
         A_ptr[0] = A_mp[0].convert_to<double>();
         A_ptr[1] = A_mp[1].convert_to<double>();
         A_ptr[2] = A_mp[2].convert_to<double>();
         A_ptr[3] = tmp_v0;
         A_ptr[4] = tmp_v1;
         A_ptr[5] = tmp_v2;
         mp::cpp_int diff(diffs_ptr[correspIndex]);
         mp::cpp_int MUL_mp(MUL);
         mp::cpp_int w_mp(w_origin);
         mp::cpp_int diff_div_w;
         diff_div_w = (diff * MUL_mp) / w_mp;
         
        //  of_A0 << long(A_ptr[0]) << endl;
        //  of_A1 << long(A_ptr[1]) << endl;
        //  of_A2 << long(A_ptr[2]) << endl;
        //  of_A3 << long(A_ptr[3]) << endl;
        //  of_A4 << long(A_ptr[4]) << endl;
        //  of_A5 << long(A_ptr[5]) << endl;
        //  of_diff_div_w << long(diff_div_w) << endl;
        ...
        for(int y = 0; y < transformDim; y++)
        {
            ...
            for(int x = y; x < transformDim; x++){
                ...
                r1 = ((A_mp[y] * A_mp[x]) >> 24);
                // if (r1 < 0) r1 += 1;
                AtA_ptr[x] += r1.convert_to<double>();
                AtA_vec[y][x] += r1.convert_to<long>();
            }
            // AtB_ptr[y] += trunc2(A_ptr[y] * diffs_ptr[correspIndex] * w);
            r2 = ((A_mp[y] * diff_div_w) >> 24);
            // if (r2 < 0) r2 += 1;
            AtB_ptr[y] += r2.convert_to<double>();
            AtB_vec[y] += r2.convert_to<long>();
        }

        // of_00 << AtA_vec[0][0] << endl;
        // of_10 << AtA_vec[0][1] << endl;
        // of_20 << AtA_vec[0][2] << endl;
        // of_30 << AtA_vec[0][3] << endl;
        // of_40 << AtA_vec[0][4] << endl;
        // of_50 << AtA_vec[0][5] << endl;
        // of_11 << AtA_vec[1][1] << endl;
        // of_21 << AtA_vec[1][2] << endl;
        // of_31 << AtA_vec[1][3] << endl;
        // of_41 << AtA_vec[1][4] << endl;
        // of_51 << AtA_vec[1][5] << endl;
        // of_22 << AtA_vec[2][2] << endl;
        // of_32 << AtA_vec[2][3] << endl;
        // of_42 << AtA_vec[2][4] << endl;
        // of_52 << AtA_vec[2][5] << endl;
        // of_33 << AtA_vec[3][3] << endl;
        // of_43 << AtA_vec[3][4] << endl;
        // of_53 << AtA_vec[3][5] << endl;
        // of_44 << AtA_vec[4][4] << endl;
        // of_54 << AtA_vec[4][5] << endl;
        // of_55 << AtA_vec[5][5] << endl;
        // of_0 << long( AtB_vec[0] ) << endl;
        // of_1 << long( AtB_vec[1] ) << endl;
        // of_2 << long( AtB_vec[2] ) << endl;
        // of_3 << long( AtB_vec[3] ) << endl;
        // of_4 << long( AtB_vec[4] ) << endl;
        // of_5 << long( AtB_vec[5] ) << endl;
    }
    }
                        ...
                        Mat sigma_debug)
{
    ...
    long sigma = 0;
    mp::cpp_int sigma_mp("0");
    ifstream if_0("./XXX.txt");
    bool check_0 = if_0.good();
    if (check_0 == 0) {
        // ofstream of_0("./debug_testing_data/SW_debug_Corr_n1_x.txt");
    for(int correspIndex = 0; correspIndex < corresps.rows; correspIndex++)
    {
        const Vec4i& c = corresps_ptr[correspIndex];
        int u0 = c[0], v0 = c[1];   //src
        ...
        //std::cout << "====================test=======================" << diffs_ptr[0] <<  std::endl;
        //exit(1);
        // cout << "diff_s_mp = " << diff_mp * diff_mp << endl;
        // cout << "diff_s    = " << diffs_ptr[correspIndex] * diffs_ptr[correspIndex] << endl;
        sigma += diffs_ptr[correspIndex] * diffs_ptr[correspIndex]; //MUL^4
        sigma_mp += diff_mp * diff_mp;
    ...
    // cout << "sigma_s = " << sigma_mp << endl;
    sigma_mp = sigma_mp / correspsCount;
    sigma_mp = sqrt(sigma_mp);
    sigma = sigma_mp.convert_to<long>();
    // sigma = trunc3(std::sqrt(trunc5(sigma/correspsCount))); //MUL^2

    // cout << "sigma_ICP = " << sigma << endl;
    long tmp;
    ...
    // cout << Rt << endl;   //pylin
    // cout << "sigma " << iter << " : " << sigma << endl;    //pylin
    // cout << endl;   //pylin
    ...
    if (check_0to1 == 0) {
        ofstream of_0("./debug_testing_data/SW_debug_ICP_A0_pre.txt");
        // ofstream of_1("./debug_testing_data/SW_debug_ICP_A0.txt");
        // ofstream of_2("./debug_testing_data/SW_debug_ICP_A1.txt");
        // ofstream of_3("./debug_testing_data/SW_debug_ICP_A2.txt");
        // ofstream of_4("./debug_testing_data/SW_debug_ICP_A3.txt");
        // ofstream of_5("./debug_testing_data/SW_debug_ICP_A4.txt");
        // ofstream of_6("./debug_testing_data/SW_debug_ICP_A5.txt");
        // ofstream of_7("./debug_testing_data/SW_debug_ICP_diff_div_w.txt");
    ...
    for(int correspIndex = 0; correspIndex < corresps.rows; correspIndex++)
    {
        ...
        // of_0 << diff_div_w << endl;

        of_0 << (tp0_y_mp * n1_z_mp) - (tp0_z_mp * n1_y_mp) << endl; //A0_pre
        ...
        for(int y = 0; y < transformDim; y++)
        {
            ...
            AtB_vec[y] = AtB_vec[y] + r2.convert_to<long>();
        ...
        // of_00 << long( AtA_vec[0][0] ) << endl;
        // of_10 << long( AtA_vec[0][1] ) << endl;
        // of_20 << long( AtA_vec[0][2] ) << endl;
        // of_30 << long( AtA_vec[0][3] ) << endl;
        // of_40 << long( AtA_vec[0][4] ) << endl;
        // of_50 << long( AtA_vec[0][5] ) << endl;
        // of_11 << long( AtA_vec[1][1] ) << endl;
        // of_21 << long( AtA_vec[1][2] ) << endl;
        // of_31 << long( AtA_vec[1][3] ) << endl;
        // of_41 << long( AtA_vec[1][4] ) << endl;
        // of_51 << long( AtA_vec[1][5] ) << endl;
        // of_22 << long( AtA_vec[2][2] ) << endl;
        // of_32 << long( AtA_vec[2][3] ) << endl;
        // of_42 << long( AtA_vec[2][4] ) << endl;
        // of_52 << long( AtA_vec[2][5] ) << endl;
        // of_33 << long( AtA_vec[3][3] ) << endl;
        // of_43 << long( AtA_vec[3][4] ) << endl;
        // of_53 << long( AtA_vec[3][5] ) << endl;
        // of_44 << long( AtA_vec[4][4] ) << endl;
        // of_54 << long( AtA_vec[4][5] ) << endl;
        // of_55 << long( AtA_vec[5][5] ) << endl;
        // of_0 << long( AtB_vec[0] ) << endl;
        // of_1 << long( AtB_vec[1] ) << endl;
        // of_2 << long( AtB_vec[2] ) << endl;
        // of_3 << long( AtB_vec[3] ) << endl;
        ...
        // cout << "A[0][0]" <<long( AtA_vec[0][0] ) << endl;
        // cout << "A[0][1]" <<long( AtA_vec[0][1] ) << endl;
        // cout << "A[0][2]" <<long( AtA_vec[0][2] ) << endl;
        // cout << "A[0][3]" <<long( AtA_vec[0][3] ) << endl;
        // cout << "A[0][4]" <<long( AtA_vec[0][4] ) << endl;
        // cout << "A[0][5]" <<long( AtA_vec[0][5] ) << endl;
        // cout << "A[1][1]" <<long( AtA_vec[1][1] ) << endl;
        // cout << "A[1][2]" <<long( AtA_vec[1][2] ) << endl;
        // cout << "A[1][3]" <<long( AtA_vec[1][3] ) << endl;
        // cout << "A[1][4]" <<long( AtA_vec[1][4] ) << endl;
        // cout << "A[1][5]" <<long( AtA_vec[1][5] ) << endl;
        // cout << "A[2][2]" <<long( AtA_vec[2][2] ) << endl;
        // cout << "A[2][3]" <<long( AtA_vec[2][3] ) << endl;
        // cout << "A[2][4]" <<long( AtA_vec[2][4] ) << endl;
        // cout << "A[2][5]" <<long( AtA_vec[2][5] ) << endl;
        // cout << "A[3][3]" <<long( AtA_vec[3][3] ) << endl;
        // cout << "A[3][4]" <<long( AtA_vec[3][4] ) << endl;
        // cout << "A[3][5]" <<long( AtA_vec[3][5] ) << endl;
        // cout << "A[4][4]" <<long( AtA_vec[4][4] ) << endl;
        // cout << "A[4][5]" <<long( AtA_vec[4][5] ) << endl;
        // cout << "A[5][5]" <<long( AtA_vec[5][5] ) << endl;
        // cout << "B[0]" <<long( AtB_vec[0] ) << endl;
        // cout << "B[1]" <<long( AtB_vec[1] ) << endl;
        // cout << "B[2]" <<long( AtB_vec[2] ) << endl;
        // cout << "B[3]" <<long( AtB_vec[3] ) << endl;
        // cout << "B[4]" <<long( AtB_vec[4] ) << endl;
        // cout << "B[5]" <<long( AtB_vec[5] ) << endl;
    }
                            ...
                            int transformDim)
{
    ...
    // ofstream f_diff_x("./debug_diffs_x_SW.txt");
    // ofstream f_diff_y("./debug_diffs_y_SW.txt");

    // ofstream f_tp0_x("./debug_testing_data/debug_tp0_x_SW.txt");
    // ofstream f_tp0_y("./debug_testing_data/debug_tp0_y_SW.txt");
    // ofstream f_tp0_z("./debug_testing_data/debug_tp0_z_SW.txt");
    ...
    for(int correspIndex = 0; correspIndex < corresps.rows; correspIndex++)
    {
        ...
        // long p0x_Rt0  = (long(p0.x * Rt_ptr[0]) >= 0) ? (long(p0.x * Rt_ptr[0]) >> 24) : ((long(p0.x * Rt_ptr[0]) >> 24) - 1);
        // long p0y_Rt1  = (long(p0.y * Rt_ptr[1]) >= 0) ? (long(p0.y * Rt_ptr[1]) >> 24) : ((long(p0.y * Rt_ptr[1]) >> 24) - 1);
        // long p0z_Rt2  = (long(p0.z * Rt_ptr[2]) >= 0) ? (long(p0.z * Rt_ptr[2]) >> 24) : ((long(p0.z * Rt_ptr[2]) >> 24) - 1);
        // long p0x_Rt4  = (long(p0.x * Rt_ptr[4]) >= 0) ? (long(p0.x * Rt_ptr[4]) >> 24) : ((long(p0.x * Rt_ptr[4]) >> 24) - 1);
        // long p0y_Rt5  = (long(p0.y * Rt_ptr[5]) >= 0) ? (long(p0.y * Rt_ptr[5]) >> 24) : ((long(p0.y * Rt_ptr[5]) >> 24) - 1);
        // long p0z_Rt6  = (long(p0.z * Rt_ptr[6]) >= 0) ? (long(p0.z * Rt_ptr[6]) >> 24) : ((long(p0.z * Rt_ptr[6]) >> 24) - 1);
        // long p0x_Rt8  = (long(p0.x * Rt_ptr[8]) >= 0) ? (long(p0.x * Rt_ptr[8]) >> 24) : ((long(p0.x * Rt_ptr[8]) >> 24) - 1);
        // long p0y_Rt9  = (long(p0.y * Rt_ptr[9]) >= 0) ? (long(p0.y * Rt_ptr[9]) >> 24) : ((long(p0.y * Rt_ptr[9]) >> 24) - 1);
        // long p0z_Rt10 = (long(p0.z * Rt_ptr[10]) >= 0) ? (long(p0.z * Rt_ptr[10]) >> 24) : ((long(p0.z * Rt_ptr[10]) >> 24) - 1);
        // long p0x_Rt0  = ((long(p0.x * Rt_ptr[0]) >> 24) - 1);
        // long p0y_Rt1  = ((long(p0.y * Rt_ptr[1]) >> 24) - 1);
        // long p0z_Rt2  = ((long(p0.z * Rt_ptr[2]) >> 24) - 1);
        // long p0x_Rt4  = ((long(p0.x * Rt_ptr[4]) >> 24) - 1);
        // long p0y_Rt5  = ((long(p0.y * Rt_ptr[5]) >> 24) - 1);
        // long p0z_Rt6  = ((long(p0.z * Rt_ptr[6]) >> 24) - 1);
        // long p0x_Rt8  = ((long(p0.x * Rt_ptr[8]) >> 24) - 1);
        // long p0y_Rt9  = ((long(p0.y * Rt_ptr[9]) >> 24) - 1);
        // long p0z_Rt10 = ((long(p0.z * Rt_ptr[10]) >> 24) - 1);
        // tp0.x = p0x_Rt0 + p0y_Rt1 + p0z_Rt2 + Rt_ptr[3] ;
        // tp0.y = p0x_Rt4 + p0y_Rt5 + p0z_Rt6 + Rt_ptr[7] ;
        // tp0.z = p0x_Rt8 + p0y_Rt9 + p0z_Rt10 + Rt_ptr[11];

        // f_tp0_x << long(tp0.x) << endl;
        // f_tp0_y << long(tp0.y) << endl;
        // f_tp0_z << long(tp0.z) << endl;
        //mpz_t p0_x;
        //mpz_t p0_y;
        //mpz_t p0_z;
        //mpz_t Rt_4;
        ...
        // f_diff_x << long(diffs_x_ptr[correspIndex]) << endl;
        // f_diff_y << long(diffs_y_ptr[correspIndex]) << endl;
    ...
    // ifstream if0("./debug_feature_corresp_u0_0to1_SW.txt");
    // bool check_if0 = if0.good();
    // ifstream if1("./debug_feature_corresp_u0_1to2_SW.txt");
    // bool check_if1 = if1.good();
    // ifstream if2("./debug_feature_corresp_u0_2to3_SW.txt");
    // bool check_if2 = if2.good();
    // ifstream if3("./debug_feature_corresp_u0_3to4_SW.txt");
    // bool check_if3 = if3.good();
    // if (check_if0 == 0) {
    //     ofstream of0("./debug_feature_corresp_u0_0to1_SW.txt");
    //     for(int correspIndex = 0; correspIndex < corresps.rows; correspIndex++)
    //     {   
    //         of0 << hex << corresps_ptr[correspIndex][0] << endl;
    //     }
    // }
    // else if (check_if1 == 0) {
    //     ofstream of1("./debug_feature_corresp_u0_1to2_SW.txt");
    //     for(int correspIndex = 0; correspIndex < corresps.rows; correspIndex++)
    //     {   
    //         of1 << hex << corresps_ptr[correspIndex][0] << endl;
    //     }
    // }
    // else if (check_if2 == 0) {
    //     ofstream of2("./debug_feature_corresp_u0_2to3_SW.txt");
    //     for(int correspIndex = 0; correspIndex < corresps.rows; correspIndex++)
    //     {   
    //         of2 << hex << corresps_ptr[correspIndex][0] << endl;
    //     }
    // }
    // else if (check_if3 == 0) {
    //     ofstream of3("./debug_feature_corresp_u0_3to4_SW.txt");
    //     for(int correspIndex = 0; correspIndex < corresps.rows; correspIndex++)
    //     {   
    //         of3 << hex << corresps_ptr[correspIndex][0] << endl;
    //     }
    // }
    // else {
    //     ofstream of4("./debug_feature_corresp_u0_4to5_SW.txt");
    // }
    // cout << "Rt = " << Rt << endl;

    // ofstream f_Ax_0("./debug_testing_data/debug_Ax_0_SW.txt");
    // ofstream f_Ax_1("./debug_testing_data/debug_Ax_1_SW.txt");
    // ofstream f_Ax_2("./debug_testing_data/debug_Ax_2_SW.txt");
    // ofstream f_Ax_3("./debug_testing_data/debug_Ax_3_SW.txt");
    // ofstream f_Ax_4("./debug_testing_data/debug_Ax_4_SW.txt");
    // ofstream f_Ax_5("./debug_testing_data/debug_Ax_5_SW.txt");
    // ofstream f_Ay_0("./debug_testing_data/debug_Ay_0_SW.txt");
    // ofstream f_Ay_1("./debug_testing_data/debug_Ay_1_SW.txt");
    // ofstream f_Ay_2("./debug_testing_data/debug_Ay_2_SW.txt");
    // ofstream f_Ay_3("./debug_testing_data/debug_Ay_3_SW.txt");
    // ofstream f_Ay_4("./debug_testing_data/debug_Ay_4_SW.txt");
    // ofstream f_Ay_5("./debug_testing_data/debug_Ay_5_SW.txt");
    
    // ofstream f_M_00("./debug_testing_data/debug_M_00_SW.txt");
    // ofstream f_M_10("./debug_testing_data/debug_M_10_SW.txt");
    // ofstream f_M_20("./debug_testing_data/debug_M_20_SW.txt");
    // ofstream f_M_30("./debug_testing_data/debug_M_30_SW.txt");
    // ofstream f_M_40("./debug_testing_data/debug_M_40_SW.txt");
    // ofstream f_M_50("./debug_testing_data/debug_M_50_SW.txt");
    // ofstream f_M_11("./debug_testing_data/debug_M_11_SW.txt");
    // ofstream f_M_21("./debug_testing_data/debug_M_21_SW.txt");
    // ofstream f_M_31("./debug_testing_data/debug_M_31_SW.txt");
    // ofstream f_M_41("./debug_testing_data/debug_M_41_SW.txt");
    // ofstream f_M_51("./debug_testing_data/debug_M_51_SW.txt");
    // ofstream f_M_22("./debug_testing_data/debug_M_22_SW.txt");
    // ofstream f_M_32("./debug_testing_data/debug_M_32_SW.txt");
    // ofstream f_M_42("./debug_testing_data/debug_M_42_SW.txt");
    // ofstream f_M_52("./debug_testing_data/debug_M_52_SW.txt");
    // ofstream f_M_33("./debug_testing_data/debug_M_33_SW.txt");
    // ofstream f_M_43("./debug_testing_data/debug_M_43_SW.txt");
    // ofstream f_M_53("./debug_testing_data/debug_M_53_SW.txt");
    // ofstream f_M_44("./debug_testing_data/debug_M_44_SW.txt");
    // ofstream f_M_54("./debug_testing_data/debug_M_54_SW.txt");
    // ofstream f_M_55("./debug_testing_data/debug_M_55_SW.txt");
    // ofstream f_V_0("./debug_testing_data/debug_V_0_SW.txt");
    // ofstream f_V_1("./debug_testing_data/debug_V_1_SW.txt");
    // ofstream f_V_2("./debug_testing_data/debug_V_2_SW.txt");
    // ofstream f_V_3("./debug_testing_data/debug_V_3_SW.txt");
    // ofstream f_V_4("./debug_testing_data/debug_V_4_SW.txt");
    // ofstream f_V_5("./debug_testing_data/debug_V_5_SW.txt");
    ...
    for(int correspIndex = 0; correspIndex < corresps.rows; correspIndex++)
    {
        ...
        // f_Ax_0 << long(A_ptr_x[0]) << endl;
        // f_Ax_1 << long(A_ptr_x[1]) << endl;
        // f_Ax_2 << long(A_ptr_x[2]) << endl;
        // f_Ax_3 << long(A_ptr_x[3]) << endl;
        // f_Ax_4 << long(A_ptr_x[4]) << endl;
        // f_Ax_5 << long(A_ptr_x[5]) << endl;
        // f_Ay_0 << long(A_ptr_y[0]) << endl;
        // f_Ay_1 << long(A_ptr_y[1]) << endl;
        // f_Ay_2 << long(A_ptr_y[2]) << endl;
        // f_Ay_3 << long(A_ptr_y[3]) << endl;
        // f_Ay_4 << long(A_ptr_y[4]) << endl;
        // f_Ay_5 << long(A_ptr_y[5]) << endl;
        ...
        // f_M_00 << long(AtA.at<double>(0,0)) << endl;
        // f_M_10 << long(AtA.at<double>(0,1)) << endl;
        // f_M_20 << long(AtA.at<double>(0,2)) << endl;
        // f_M_30 << long(AtA.at<double>(0,3)) << endl;
        // f_M_40 << long(AtA.at<double>(0,4)) << endl;
        // f_M_50 << long(AtA.at<double>(0,5)) << endl;
        // f_M_11 << long(AtA.at<double>(1,1)) << endl;
        // f_M_21 << long(AtA.at<double>(1,2)) << endl;
        // f_M_31 << long(AtA.at<double>(1,3)) << endl;
        // f_M_41 << long(AtA.at<double>(1,4)) << endl;
        // f_M_51 << long(AtA.at<double>(1,5)) << endl;
        // f_M_22 << long(AtA.at<double>(2,2)) << endl;
        // f_M_32 << long(AtA.at<double>(2,3)) << endl;
        // f_M_42 << long(AtA.at<double>(2,4)) << endl;
        // f_M_52 << long(AtA.at<double>(2,5)) << endl;
        // f_M_33 << long(AtA.at<double>(3,3)) << endl;
        // f_M_43 << long(AtA.at<double>(3,4)) << endl;
        // f_M_53 << long(AtA.at<double>(3,5)) << endl;
        // f_M_44 << long(AtA.at<double>(4,4)) << endl;
        // f_M_54 << long(AtA.at<double>(4,5)) << endl;
        // f_M_55 << long(AtA.at<double>(5,5)) << endl;
        // f_V_0 << long(AtB_ptr[0]) << endl;
        // f_V_1 << long(AtB_ptr[1]) << endl;
        // f_V_2 << long(AtB_ptr[2]) << endl;
        // f_V_3 << long(AtB_ptr[3]) << endl;
        // f_V_4 << long(AtB_ptr[4]) << endl;
        // f_V_5 << long(AtB_ptr[5]) << endl;
...
static
bool solveSystem(const Mat& AtA, 
                 const Mat& AtB, 
                 std::vector<std::vector<long>>& AtA_vec, 
                 std::vector<long>& AtB_vec,
                 double detThreshold, 
                 Mat& x)  //output ksi(x); determinantThreshold(detThreshold) = 1e-6
{
    ...
    vector<vector<mp::cpp_int>> AtA_mp(transformDim, vector<mp::cpp_int>(transformDim, 0));
    vector<mp::cpp_int> AtB_mp(transformDim, 0);

    for(int i = 0; i < rows; i++){
        for(int j = 0; j < rows; j++){
            AtA_mp[i][j] = AtA_vec[i][j];
        }
        AtB_mp[i] = AtB_vec[i];
    }

    mp::cpp_int tmp_mp, tmp_shift_mp;
    // mp::cpp_int mask_mp = (1 << 24) -1;

    string filename = "./Div_Shift_cmp_shift.txt";
    ifstream if1(filename);
    bool if1_check = if1.good();
    if (if1_check == 0) {
    ...
    for(int k = 0; k < rows; k++)
    {
        for(int m = 0; m < k; m++) //dkk = akk - lkm * lkm * dmm  = akk - lkm * umk 
        {
            ...
            tmp_mp = AtA_mp[k][k];
            // AtA_mp[k][k] = AtA_mp[k][k] - ((AtA_mp[k][m] * AtA_mp[m][k]) / MUL_mp);
            tmp_shift_mp = (AtA_mp[k][m] * AtA_mp[m][k]);
            if ((AtA_mp[k][m] * AtA_mp[m][k]) >= 0) AtA_mp[k][k] = AtA_mp[k][k] - ((AtA_mp[k][m] * AtA_mp[m][k]) >> 24);
            else AtA_mp[k][k] = AtA_mp[k][k] - (((AtA_mp[k][m] * AtA_mp[m][k]) >> 24) + 1);
            // AtA_mp[k][k] = AtA_mp[k][k] - ((AtA_mp[k][m] * AtA_mp[m][k]) >> 24);
            // of1 << "1: AtA_mp[k][k] = AtA_mp[k][k] - AtA_mp[k][m] * AtA_mp[m][k] / MUL_mp;  " << AtA_mp[k][k] << " = " << tmp_mp << " - " << AtA_mp[k][m] << " * " << AtA_mp[m][k] << " / MUL" << endl;
        }
        ...
        for(int i = k+1; i < cols; i++)
        {
            for(int m = 0; m < k; m++) //uki = aki - lkm * umi
            {
                ...
                tmp_mp = AtA_mp[k][i];
                //  AtA_mp[k][i] = AtA_mp[k][i] - ((AtA_mp[m][i] * AtA_mp[k][m]) / MUL_mp);
                tmp_shift_mp = (AtA_mp[m][i] * AtA_mp[k][m]);
                if (tmp_shift_mp >= 0) AtA_mp[k][i] = AtA_mp[k][i] - ((AtA_mp[m][i] * AtA_mp[k][m]) >> 24);
                else AtA_mp[k][i] = AtA_mp[k][i] - (((AtA_mp[m][i] * AtA_mp[k][m]) >> 24) + 1);
                // AtA_mp[k][i] = AtA_mp[k][i] - ((AtA_mp[m][i] * AtA_mp[k][m]) >> 24);
                // of1 << "2: AtA_mp[k][i] = AtA_mp[k][i] - AtA_mp[m][i] * AtA_mp[k][m] / MUL_mp;  " << AtA_mp[k][i] << " = " << tmp_mp << " - " << AtA_mp[m][i] << " * " << AtA_mp[k][m] << " / MUL" << endl;
            }
            ...
            AtA_mp[i][k] = AtA_mp[k][i] * MUL_mp / AtA_mp[k][k];
            // of1 << "3: AtA_mp[i][k] = AtA_mp[k][i] * MUL_mp / AtA_mp[k][k];  " << AtA_mp[i][k] << " = " << AtA_mp[k][i] << " * MUL / " << AtA_mp[k][k] << endl;
        }
    }
    ...
    for(int i = 0; i < rows; i++)
    {
        for(int k = 0; k < i; k++)
        {
            ...
            tmp_mp = AtB_mp[i];
            // AtB_mp[i] = AtB_mp[i] - ((AtA_mp[i][k] * AtB_mp[k]) / MUL_mp);
            tmp_shift_mp = (AtA_mp[i][k] * AtB_mp[k]);
            if (tmp_shift_mp >= 0 ) AtB_mp[i] = AtB_mp[i] - ((AtA_mp[i][k] * AtB_mp[k]) >> 24);
            else AtB_mp[i] = AtB_mp[i] - (((AtA_mp[i][k] * AtB_mp[k]) >> 24) + 1);
            // AtB_mp[i] = AtB_mp[i] - ((AtA_mp[i][k] * AtB_mp[k]) >> 24);
            // of1 << "4: AtB_mp[i] = AtB_mp[i] - (AtA_mp[i][k] * AtB_mp[k]) / MUL_mp;  " << AtB_mp[i] << " = " << tmp_mp << " - " << AtA_mp[i][k] << " * " << AtB_mp[k] << " / MUL" << endl;
        }
    }
    ...
    for(int i = rows-1; i >= 0; i--)
    {
        ...
        tmp_mp = AtB_mp[i];
        AtB_mp[i] = AtB_mp[i] * MUL_mp / AtA_mp[i][i];
        // of1 << "5: AtB_mp[i] = AtB_mp[i] * MUL_mp / AtA_mp[i][i];  " << AtB_mp[i] << " = " << tmp_mp << " * MUL / " << AtA_mp[i][i] << endl;
        for(int k = i+1; k < rows; k++)
        {
            // B.at<double>(i, 0) = B.at<double>(i, 0) - trunc6((A.at<double>(k, i) * B.at<double>(k, 0)) / MUL);
            tmp_mp = AtB_mp[i];
            // AtB_mp[i] = AtB_mp[i] - (AtA_mp[k][i] * AtB_mp[k] / MUL_mp);
            tmp_shift_mp = (AtA_mp[k][i] * AtB_mp[k]);
            if (tmp_shift_mp >= 0) AtB_mp[i] = AtB_mp[i] - ((AtA_mp[k][i] * AtB_mp[k]) >> 24);
            else AtB_mp[i] = AtB_mp[i] - (((AtA_mp[k][i] * AtB_mp[k]) >> 24) + 1);
            // AtB_mp[i] = AtB_mp[i] - ((AtA_mp[k][i] * AtB_mp[k]) >> 24);
            // of1 << "6: AtB_mp[i] = AtB_mp[i] - AtA_mp[k][i] * AtB_mp[k] / MUL_mp;  " << AtB_mp[i] << " = " << tmp_mp << " - " << AtA_mp[k][i] << " * " << AtB_mp[k] << " / MUL" << endl;
        }
    }
    }
    ...
    // x = B;
    x.create(6, 1 , CV_64FC1);
    x.at<double>(0,0) = AtB_mp[0].convert_to<double>();
    x.at<double>(1,0) = AtB_mp[1].convert_to<double>();
    x.at<double>(2,0) = AtB_mp[2].convert_to<double>();
    x.at<double>(3,0) = AtB_mp[3].convert_to<double>();
    x.at<double>(4,0) = AtB_mp[4].convert_to<double>();
    x.at<double>(5,0) = AtB_mp[5].convert_to<double>();

    if ((x.at<double>(0,0) == 0) && (x.at<double>(1,0) == 0) && (x.at<double>(2,0) == 0))
        return false;

    // ifstream if2("B_solver.txt");
    // bool check_if2 = if2.good();
    // if (check_if2 == 0) {
    //     ofstream of2("B_solver.txt");
    //     of2 << "Mat B : " << endl;
    //     for (int i = 0; i < 6; i++){
    //         of2 << long(B.at<double>(i,0)) << endl;
    //     }
    //     of2 << "Mat x from Vec B : " << endl;
    //     for (int i = 0; i < 6; i++){
    //         of2 << long(x.at<double>(i,0)) << endl;
    //     }
    //     of2 << "Vec B : " << endl;
    //     for (int i = 0; i < 6; i++){
    //         of2 << AtB_mp[i] << endl;
...
bool computeProjectiveMatrix(const Mat& ksi, Mat& Rt, double maxTranslation, double maxRotation)
{
    ...
    // cout << "----computeProjectiveMatrix start----" << endl;
    // cout << "ksi_0 = " << ksi.at<double>(0) << endl;
    // cout << "ksi_1 = " << ksi.at<double>(1) << endl;
    // cout << "ksi_2 = " << ksi.at<double>(2) << endl;
    // cout << "ksi_3 = " << ksi.at<double>(3) << endl;
    // cout << "ksi_4 = " << ksi.at<double>(4) << endl;
    // cout << "ksi_5 = " << ksi.at<double>(5) << endl;
    ...
    // cout << "Rt.at<double>(0,0) = c + trunc1(c1*rrt(0,0)/MUL) + trunc1(s*r_x(0,0)/MUL) = " << c + trunc1(c1*rrt(0,0)/MUL) + trunc1(s*r_x(0,0)/MUL) << endl;
    Rt.at<double>(0,0) = c + trunc1(c1*rrt(0,0)/MUL) + trunc1(s*r_x(0,0)/MUL);
    // cout << "Rt.at<double>(1,0) = trunc1(c1*rrt(1,0)/MUL) + trunc1(s*r_x(1,0)/MUL) = " << trunc1(c1*rrt(1,0)/MUL) + trunc1(s*r_x(1,0)/MUL) << endl;
    Rt.at<double>(1,0) = trunc1(c1*rrt(1,0)/MUL) + trunc1(s*r_x(1,0)/MUL);
    // cout << "Rt.at<double>(2,0) = trunc1(c1*rrt(2,0)/MUL) + trunc1(s*r_x(2,0)/MUL) = " << trunc1(c1*rrt(2,0)/MUL) + trunc1(s*r_x(2,0)/MUL) << endl;
    Rt.at<double>(2,0) = trunc1(c1*rrt(2,0)/MUL) + trunc1(s*r_x(2,0)/MUL);
    // cout << "Rt.at<double>(0,1) = trunc1(c1*rrt(0,1)/MUL) + trunc1(s*r_x(0,1)/MUL) = " << trunc1(c1*rrt(0,1)/MUL) + trunc1(s*r_x(0,1)/MUL) << endl;
    Rt.at<double>(0,1) = trunc1(c1*rrt(0,1)/MUL) + trunc1(s*r_x(0,1)/MUL);
    // cout << "Rt.at<double>(1,1) = c + trunc1(c1*rrt(1,1)/MUL) + trunc1(s*r_x(1,1)/MUL) = " << c + trunc1(c1*rrt(1,1)/MUL) + trunc1(s*r_x(1,1)/MUL) << endl;
    Rt.at<double>(1,1) = c + trunc1(c1*rrt(1,1)/MUL) + trunc1(s*r_x(1,1)/MUL);
    // cout << "Rt.at<double>(2,1) = trunc1(c1*rrt(2,1)/MUL) + trunc1(s*r_x(2,1)/MUL) = " << trunc1(c1*rrt(2,1)/MUL) + trunc1(s*r_x(2,1)/MUL) << endl;
    Rt.at<double>(2,1) = trunc1(c1*rrt(2,1)/MUL) + trunc1(s*r_x(2,1)/MUL);
    // cout << "Rt.at<double>(0,2) = trunc1(c1*rrt(0,2)/MUL) + trunc1(s*r_x(0,2)/MUL) = " << trunc1(c1*rrt(0,2)/MUL) + trunc1(s*r_x(0,2)/MUL) << endl;
    Rt.at<double>(0,2) = trunc1(c1*rrt(0,2)/MUL) + trunc1(s*r_x(0,2)/MUL);
    // cout << "Rt.at<double>(1,2) = trunc1(c1*rrt(1,2)/MUL) + trunc1(s*r_x(1,2)/MUL) = " << trunc1(c1*rrt(1,2)/MUL) + trunc1(s*r_x(1,2)/MUL) << endl;
    Rt.at<double>(1,2) = trunc1(c1*rrt(1,2)/MUL) + trunc1(s*r_x(1,2)/MUL);
    // cout << "Rt.at<double>(2,2) = c + trunc1(c1*rrt(2,2)/MUL) + trunc1(s*r_x(2,2)/MUL) = " << c + trunc1(c1*rrt(2,2)/MUL) + trunc1(s*r_x(2,2)/MUL) << endl;
    Rt.at<double>(2,2) = c + trunc1(c1*rrt(2,2)/MUL) + trunc1(s*r_x(2,2)/MUL);

    // cout << "----computeProjectiveMatrix end----" << endl;
...
Size Odometry::prepareFrameCache(Ptr<OdometryFrame>& frame, int cacheType) const
{
    ...
    frame->dI_dx = Mat(frame->image.rows, frame->image.cols, CV_16SC1, Scalar(0));
    frame->dI_dy = Mat(frame->image.rows, frame->image.cols, CV_16SC1, Scalar(0));
    for(int x = 1; x < frame->image.cols-1; x++){
        for (int y = 0; y < frame->image.rows; y++){
            frame->dI_dx.at<short>(y,x) = frame->image.at<uint8_t>(y,x+1) - frame->image.at<uint8_t>(y,x);
        }
    }
    for (int x = 0; x < frame->image.cols; x++){
        for(int y = 1; y < frame->image.rows-1; y++){
            frame->dI_dy.at<short>(y,x) = frame->image.at<uint8_t>(y+1,x) - frame->image.at<uint8_t>(y,x);
        }
    }

    // ifstream if0("./debug_img0_SW.txt");
    // bool check_if0 = if0.good();
    // ifstream if1("./debug_img1_SW.txt");
    // bool check_if1 = if1.good();
    // if (check_if0 == 0) {
    //     // ofstream debug_dI_dx("./debug_dI_dx_SW.txt");
    //     // ofstream debug_dI_dy("./debug_dI_dy_SW.txt");
    //     ofstream debug_rgb0("./debug_img0_SW.txt");
    //     for(int y = 0; y < frame->image.rows; y++){
    //         for (int x = 0; x < frame->image.cols; x++){
    //             // debug_dI_dx << frame->dI_dx.at<short>(y,x) << endl;
    //             // debug_dI_dy << frame->dI_dy.at<short>(y,x) << endl;
    //             debug_rgb0 << short(frame->image.at<uint8_t>(y,x)) << endl;
    //         }
    //     }
    // }
    // else if (check_if1 == 0) {
    //     ofstream debug_rgb1("./debug_img1_SW.txt");
    //     for(int y = 0; y < frame->image.rows; y++){
    //         for (int x = 0; x < frame->image.cols; x++){
    //             // debug_dI_dx << frame->dI_dx.at<short>(y,x) << endl;
    //             // debug_dI_dy << frame->dI_dy.at<short>(y,x) << endl;
    //             debug_rgb1 << short(frame->image.at<uint8_t>(y,x)) << endl;
    //         }
    //     }
    // }

    // ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ pylin
    // ifstream if_1("./rgbd_1.txt");
    // ifstream if_2("./rgbd_2.txt");
    // ifstream if_3("./rgbd_3.txt");
    // ifstream if_4("./rgbd_4.txt");
    // ifstream if_5("./rgbd_5.txt");
    // bool if_1_ok = if_1.good();
    // bool if_2_ok = if_2.good();
    // bool if_3_ok = if_3.good();
    // bool if_4_ok = if_4.good();
    // bool if_5_ok = if_5.good();
    // if (if_1_ok == 0){
    //     ofstream rgbd_1("./rgbd_1.txt");
    //     for (int y = 0; y < frame->image.rows; ++y){
    //         for (int x = 0; x < frame->image.cols; ++x){
    //             rgbd_1 << hex << short(frame->image.at<uint8_t>(y,x)) << endl;
    //         }
    //     }
    // }
    // else if (if_2_ok == 0){
    //     ofstream rgbd_2("./rgbd_2.txt");
    //     for (int y = 0; y < frame->image.rows; ++y){
    //         for (int x = 0; x < frame->image.cols; ++x){
    //             rgbd_2 << hex << short(frame->image.at<uint8_t>(y,x)) << endl;
    //         }
    //     }
    // }
    // else if (if_3_ok == 0){
    //     ofstream rgbd_3("./rgbd_3.txt");
    //     for (int y = 0; y < frame->image.rows; ++y){
    //         for (int x = 0; x < frame->image.cols; ++x){
    //             rgbd_3 << hex << short(frame->image.at<uint8_t>(y,x)) << endl;
    //         }
    //     }
    // }
    // else if (if_4_ok == 0){
    //     ofstream rgbd_4("./rgbd_4.txt");
    //     for (int y = 0; y < frame->image.rows; ++y){
    //         for (int x = 0; x < frame->image.cols; ++x){
    //             rgbd_4 << hex << short(frame->image.at<uint8_t>(y,x)) << endl;
    //         }
    //     }
    // }
    // else if (if_5_ok == 0){
    //     ofstream rgbd_5("./rgbd_5.txt");
    //     for (int y = 0; y < frame->image.rows; ++y){
    //         for (int x = 0; x < frame->image.cols; ++x){
    //             rgbd_5 << hex << short(frame->image.at<uint8_t>(y,x)) << endl;
    //         }
    //     }
    // }

    // ifstream if_1("./depth_1.txt");
    // ifstream if_2("./depth_2.txt");
    // ifstream if_3("./depth_3.txt");
    // ifstream if_4("./depth_4.txt");
    // ifstream if_5("./depth_5.txt");
    // bool if_1_ok = if_1.good();
    // bool if_2_ok = if_2.good();
    // bool if_3_ok = if_3.good();
    // bool if_4_ok = if_4.good();
    // bool if_5_ok = if_5.good();
    // if (if_1_ok == 0){
    //     ofstream depth_1("./depth_1.txt");
    //     for (int y = 0; y < frame->depth.rows; ++y){
    //         for (int x = 0; x < frame->depth.cols; ++x){
    //             depth_1 << hex << short(frame->depth.at<double>(y,x)) << endl;
    //         }
    //     }
    // }
    // else if (if_2_ok == 0){
    //     ofstream depth_2("./depth_2.txt");
    //     for (int y = 0; y < frame->depth.rows; ++y){
    //         for (int x = 0; x < frame->depth.cols; ++x){
    //             depth_2 << hex << short(frame->depth.at<double>(y,x)) << endl;
    //         }
    //     }
    // }
    // else if (if_3_ok == 0){
    //     ofstream depth_3("./depth_3.txt");
    //     for (int y = 0; y < frame->depth.rows; ++y){
    //         for (int x = 0; x < frame->depth.cols; ++x){
    //             depth_3 << hex << short(frame->depth.at<double>(y,x)) << endl;
    //         }
    //     }
    // }
    // else if (if_4_ok == 0){
    //     ofstream depth_4("./depth_4.txt");
    //     for (int y = 0; y < frame->depth.rows; ++y){
    //         for (int x = 0; x < frame->depth.cols; ++x){
    //             depth_4 << hex << short(frame->depth.at<double>(y,x)) << endl;
    //         }
    //     }
    // }
    // else if (if_5_ok == 0){
    //     ofstream depth_5("./depth_5.txt");
    //     for (int y = 0; y < frame->depth.rows; ++y){
    //         for (int x = 0; x < frame->depth.cols; ++x){
    //             depth_5 << hex << short(frame->depth.at<double>(y,x)) << endl;
    //         }
    //     }
    // }
    ...
    //     for (int x = 0; x < frame->image.cols; ++x)
    //     {
    //         debug_image << hex << short(frame->image.at<uint8_t>(y,x)) << endl;
...
bool Odometry::compute(Ptr<OdometryFrame>& srcFrame, Ptr<OdometryFrame>& dstFrame, Mat& Rt, int& v_max, Mat& sigma_debug, const Mat& initRt) const
{
    ...
    Mat testRt = initRt.empty() ? Mat::eye(4,4,CV_64FC1)*MUL : initRt.clone();
    Mat currRt, ksi;
    ...
    bool isOk = false;
    {
        ...
        int n_of_all = n_of_f + n_of_d;

        // Run transformation search on current level iteratively.
        // for(int iter = 0; iter < iterCounts_vec[0]; iter ++)    //iterCounts_vec[0] = 8
        for(int iter = 0; iter < n_of_all; iter ++)  //pylin test
        {   
            std::vector<std::vector<long>> AtA_vec(transformDim, vector<long>(transformDim, 0));
            std::vector<std::vector<long>> AtA_icp_vec(transformDim, vector<long>(transformDim, 0));
            std::vector<std::vector<long>> AtA_rgbd_vec(transformDim, vector<long>(transformDim, 0));
            std::vector<long> AtB_vec(6, 0);
            std::vector<long> AtB_icp_vec(6, 0);
            std::vector<long> AtB_rgbd_vec(6, 0);
            ...
            if(iter >= n_of_f){  //pylin test
                ...
                if (v_icp > v_max)
                    v_max = v_icp;
                */
               cout << "---computeCorresps_hw start---" << endl;
                int v_rgbd = computeCorresps_hw(levelCameraMatrix, 
                                                ...
                                                dstFrame->normals,
                                                debug); //pylin debug
                cout << "---computeCorresps_hw end---" << endl;
               ...
               //cout << "corresps_icp " << corresps_icp.size() << endl;
                ...
                {
                    cout << "---calcRgbdLsmMatrices start---" << endl;
                    calcRgbdLsmMatrices(srcFrame->image, 
                                        srcFrame->cloud, 
                                        resultRt, //srcFrame->image is grey
                                        dstFrame->image, 
                                        dstFrame->dI_dx, dstFrame->dI_dy,
                                        corresps_rgbd, 
                                        fx, fy, 
                                        sobelScale,
                                        AtA_rgbd, AtB_rgbd, 
                                        AtA_rgbd_vec, AtB_rgbd_vec,
                                        rgbdEquationFuncPtr, 
                                        transformDim,
                                        sigma_debug);
                    cout << "---calcRgbdLsmMatrices end---" << endl;

                    //AtA += AtA_rgbd / MUL;
                    //AtB += AtB_rgbd / MUL;
                    AtA += AtA_rgbd;
                    AtB += AtB_rgbd;
                    for (int i = 0; i < transformDim; i++){
                        for (int j = 0; j < transformDim; j++){
                            AtA_vec[i][j] += AtA_rgbd_vec[i][j];
                            // cout << "AtA_rgbd[" << i << "][" << j << "] = " << AtA_vec[i][j] << endl;
                        }
                        AtB_vec[i] += AtB_rgbd_vec[i];
                    }
                    // for (int i = 0; i < transformDim; i++){
                    //     for (int j = i; j < transformDim; j++){
                    //         cout << "AtA_rgbd_vec[" << i << "][" << j << "] = " << AtA_rgbd_vec[i][j] << endl;
                    //         // cout << "AtA_rgbd[" << i << "][" << j << "] = " << AtA_vec[i][j] << endl;
                    //     }
                    // }
                    // for (int i = 0; i < transformDim; i++){
                    //     cout << "AtB_rgbd_vec[" << i << "] = " << AtB_rgbd_vec[i] << endl;
                    // }
                }

                if(corresps_icp.rows >= minCorrespsCount)
                {   
                    cout << "---calcICPLsmMatrices start---" << endl;
                    calcICPLsmMatrices(srcFrame->cloud, 
                                       ...
                                       corresps_icp, 
                                       AtA_icp, AtB_icp, 
                                       AtA_icp_vec, AtB_icp_vec,
                                       icpEquationFuncPtr, 
                                       transformDim,
                                       iter,
                                       sigma_debug ); // pylin
                    cout << "---calcICPLsmMatrices end---" << endl;
                    //AtA += AtA_icp / MUL;
                    //AtB += AtB_icp / MUL;
                    AtA += AtA_icp;
                    AtB += AtB_icp;
                    for (int i = 0; i < transformDim; i++){
                        for (int j = 0; j < transformDim; j++){
                            AtA_vec[i][j] += AtA_icp_vec[i][j];
                            // cout << "AtA_icp[" << i << "][" << j << "] = " << AtA_vec[i][j] << endl;
                        }
                        AtB_vec[i] += AtB_icp_vec[i];
                    }
                    // for (int i = 0; i < transformDim; i++){
                    //     for (int j = i; j < transformDim; j++){
                    //         cout << "AtB_icp_vec[" << i << "][" << j << "] = " << AtA_icp_vec[i][j] << endl;
                    //     }
                    // }
                    // for (int i = 0; i < transformDim; i++){
                    //     cout << "AtB_icp_vec[" << i << "] = " << AtB_icp_vec[i] << endl;
                    // }

                    // for (int i = 0; i < transformDim; i++){
                    //     for (int j = i; j < transformDim; j++){
                    //         cout << "AtA_vec[" << i << "][" << j << "] = " << AtA_vec[i][j] << endl;
                    //     }
                    // }
                    // for (int i = 0; i < transformDim; i++){
                    //     cout << "AtB_vec[" << i << "] = " << AtB_vec[i] << endl;
                    // }
                }
            }
            else 
            {
               ...
               if(corresps_feature.rows >= feature_corr_num) //feature_corr_num = 12
               {
                   ...
                   cout << "---calcFeatureLsmMatrices start---" << endl;
                   ...
                   cout << "---calcFeatureLsmMatrices end---" << endl;

                //    cout << corresps_feature.rows << endl;

                   AtA += AtA_feature;
                   AtB += AtB_feature;
                   for (int i = 0; i < transformDim; i++){
                        for (int j = 0; j < transformDim; j++){
                            AtA_vec[i][j] += AtA_feature.at<double>(i,j);
                        }
                        AtB_vec[i] += AtB_feature.at<double>(i,0);
                    }

                    // ifstream if1("./AB_feature.txt");
                    // bool check_if1 = if1.good();
                    // if (check_if1 == 0){
                    //     ofstream of1("./AB_feature.txt");
                    //     of1 << "Mat AtA : " << endl;
                    //     for (int i = 0; i < transformDim; i++){
                    //         for (int j = 0; j < transformDim; j++){
                    //             of1 << long(AtA_feature.at<double>(i,j)) << ", ";
                    //         }
                    //         of1 << endl;
                    //     }
                    //     of1 << "Vec AtA : " << endl;
                    ...
                    //     of1 << "Mat AtB : " << endl;
                    //     for (int i = 0; i < transformDim; i++){
                    //         of1 << long(AtB.at<double>(i,0)) << endl;
                    //     }
                    //     of1 << "Vec AtB : " << endl;
                    //     for (int i = 0; i < transformDim; i++){
                    //         of1 << AtB_vec[i] << endl;
            ...
            //if(iter==1)
            //    exit(1);
            cout << "---solveSystem start---" << endl;
            bool solutionExist = solveSystem(AtA, AtB, AtA_vec, AtB_vec, determinantThreshold, ksi);  //output ksi; determinantThreshold = 1e-6
            cout << "---solveSystem end---" << endl;
            // bool solutionExist = solveSystem(AtA_vec, AtB_vec, determinantThreshold, ksi);
...
//purpose: high precision calculation
            ...
            cout << "---resultRt start---" << endl;
            // cout << "---00---" << endl;
            // cout << "currRt_cp.at<double>(0,0) = " << currRt_cp.at<double>(0,0);
            // mp::cpp_int curr_00_mp(currRt_cp.at<double>(0,0));
            // cout << "---01---" << endl;
            // mp::cpp_int curr_01_mp(currRt_cp.at<double>(0,1));
            // cout << "---02---" << endl;
            // mp::cpp_int curr_02_mp(currRt_cp.at<double>(0,2));
            // cout << "---03---" << endl;
            // mp::cpp_int curr_03_mp(currRt_cp.at<double>(0,3));
            // cout << "---10---" << endl;
            // mp::cpp_int curr_10_mp(currRt_cp.at<double>(1,0));
            // cout << "---11---" << endl;
            // mp::cpp_int curr_11_mp(currRt_cp.at<double>(1,1));
            // cout << "---12---" << endl;
            // mp::cpp_int curr_12_mp(currRt_cp.at<double>(1,2));
            // cout << "---13---" << endl;
            // mp::cpp_int curr_13_mp(currRt_cp.at<double>(1,3));
            // cout << "---20---" << endl;
            // mp::cpp_int curr_20_mp(currRt_cp.at<double>(2,0));
            // cout << "---21---" << endl;
            // mp::cpp_int curr_21_mp(currRt_cp.at<double>(2,1));
            // cout << "---22---" << endl;
            // mp::cpp_int curr_22_mp(currRt_cp.at<double>(2,2));
            // cout << "---23---" << endl;
            // mp::cpp_int curr_23_mp(currRt_cp.at<double>(2,3));
            // cout << "---30---" << endl;
            // mp::cpp_int curr_30_mp(currRt_cp.at<double>(3,0));
            // cout << "---31---" << endl;
            // mp::cpp_int curr_31_mp(currRt_cp.at<double>(3,1));
            // cout << "---32---" << endl;
            // mp::cpp_int curr_32_mp(currRt_cp.at<double>(3,2));
            // cout << "---33---" << endl;
            // mp::cpp_int curr_33_mp(currRt_cp.at<double>(3,3));
            // mp::cpp_int result_00_mp(resultRt.at<double>(0,0));
            // mp::cpp_int result_10_mp(resultRt.at<double>(1,0));
            // mp::cpp_int result_20_mp(resultRt.at<double>(2,0));
            // mp::cpp_int result_30_mp(resultRt.at<double>(3,0));
            // mp::cpp_int result_01_mp(resultRt.at<double>(0,1));
            // mp::cpp_int result_11_mp(resultRt.at<double>(1,1));
            // mp::cpp_int result_21_mp(resultRt.at<double>(2,1));
            // mp::cpp_int result_31_mp(resultRt.at<double>(3,1));
            // mp::cpp_int result_02_mp(resultRt.at<double>(0,2));
            // mp::cpp_int result_12_mp(resultRt.at<double>(1,2));
            // mp::cpp_int result_22_mp(resultRt.at<double>(2,2));
            // mp::cpp_int result_32_mp(resultRt.at<double>(3,2));
            // mp::cpp_int result_03_mp(resultRt.at<double>(0,3));
            // mp::cpp_int result_13_mp(resultRt.at<double>(1,3));
            // mp::cpp_int result_23_mp(resultRt.at<double>(2,3));
            // mp::cpp_int result_33_mp(resultRt.at<double>(3,3));
            // mp::cpp_int result_final_00_mp;
            // mp::cpp_int result_final_01_mp;
            // mp::cpp_int result_final_02_mp;
            // mp::cpp_int result_final_03_mp;
            // mp::cpp_int result_final_10_mp;
            // mp::cpp_int result_final_11_mp;
            // mp::cpp_int result_final_12_mp;
            // mp::cpp_int result_final_13_mp;
            // mp::cpp_int result_final_20_mp;
            // mp::cpp_int result_final_21_mp;
            // mp::cpp_int result_final_22_mp;
            // mp::cpp_int result_final_23_mp;
            // mp::cpp_int result_final_30_mp;
            // mp::cpp_int result_final_31_mp;
            // mp::cpp_int result_final_32_mp;
            // mp::cpp_int result_final_33_mp;
            // result_final_00_mp = ((curr_00_mp * result_00_mp) >> 24) + ((curr_01_mp * result_10_mp) >> 24) + ((curr_02_mp * result_20_mp) >> 24) + ((curr_03_mp * result_30_mp) >> 24);
            // result_final_01_mp = ((curr_00_mp * result_01_mp) >> 24) + ((curr_01_mp * result_11_mp) >> 24) + ((curr_02_mp * result_21_mp) >> 24) + ((curr_03_mp * result_31_mp) >> 24);
            // result_final_02_mp = ((curr_00_mp * result_02_mp) >> 24) + ((curr_01_mp * result_12_mp) >> 24) + ((curr_02_mp * result_22_mp) >> 24) + ((curr_03_mp * result_32_mp) >> 24);
            // result_final_03_mp = ((curr_00_mp * result_03_mp) >> 24) + ((curr_01_mp * result_13_mp) >> 24) + ((curr_02_mp * result_23_mp) >> 24) + ((curr_03_mp * result_33_mp) >> 24);
            // result_final_10_mp = ((curr_10_mp * result_00_mp) >> 24) + ((curr_11_mp * result_10_mp) >> 24) + ((curr_12_mp * result_20_mp) >> 24) + ((curr_13_mp * result_30_mp) >> 24);
            // result_final_11_mp = ((curr_10_mp * result_01_mp) >> 24) + ((curr_11_mp * result_11_mp) >> 24) + ((curr_12_mp * result_21_mp) >> 24) + ((curr_13_mp * result_31_mp) >> 24);
            // result_final_12_mp = ((curr_10_mp * result_02_mp) >> 24) + ((curr_11_mp * result_12_mp) >> 24) + ((curr_12_mp * result_22_mp) >> 24) + ((curr_13_mp * result_32_mp) >> 24);
            // result_final_13_mp = ((curr_10_mp * result_03_mp) >> 24) + ((curr_11_mp * result_13_mp) >> 24) + ((curr_12_mp * result_23_mp) >> 24) + ((curr_13_mp * result_33_mp) >> 24);
            // result_final_20_mp = ((curr_20_mp * result_00_mp) >> 24) + ((curr_21_mp * result_10_mp) >> 24) + ((curr_22_mp * result_20_mp) >> 24) + ((curr_23_mp * result_30_mp) >> 24);
            // result_final_21_mp = ((curr_20_mp * result_01_mp) >> 24) + ((curr_21_mp * result_11_mp) >> 24) + ((curr_22_mp * result_21_mp) >> 24) + ((curr_23_mp * result_31_mp) >> 24);
            // result_final_22_mp = ((curr_20_mp * result_02_mp) >> 24) + ((curr_21_mp * result_12_mp) >> 24) + ((curr_22_mp * result_22_mp) >> 24) + ((curr_23_mp * result_32_mp) >> 24);
            // result_final_23_mp = ((curr_20_mp * result_03_mp) >> 24) + ((curr_21_mp * result_13_mp) >> 24) + ((curr_22_mp * result_23_mp) >> 24) + ((curr_23_mp * result_33_mp) >> 24);
            // testRt.at<double>(0,0) = result_final_00_mp.convert_to<double>();
            // testRt.at<double>(0,1) = result_final_01_mp.convert_to<double>();
            // testRt.at<double>(0,2) = result_final_02_mp.convert_to<double>();
            // testRt.at<double>(0,3) = result_final_03_mp.convert_to<double>();
            // testRt.at<double>(1,0) = result_final_10_mp.convert_to<double>();
            // testRt.at<double>(1,1) = result_final_11_mp.convert_to<double>();
            // testRt.at<double>(1,2) = result_final_12_mp.convert_to<double>();
            // testRt.at<double>(1,3) = result_final_13_mp.convert_to<double>();
            // testRt.at<double>(2,0) = result_final_20_mp.convert_to<double>();
            // testRt.at<double>(2,1) = result_final_21_mp.convert_to<double>();
            // testRt.at<double>(2,2) = result_final_22_mp.convert_to<double>();
            // testRt.at<double>(2,3) = result_final_23_mp.convert_to<double>();
            ...
            // cout << "currRt_cp.at<double>(0,0) = " << currRt_cp.at<double>(0,0) << endl;
            mpz_init_set_d(curr_00, currRt_cp.at<double>(0,0));
            // cout << "currRt_cp.at<double>(0,1) = " << currRt_cp.at<double>(0,1) << endl;
            mpz_init_set_d(curr_01, currRt_cp.at<double>(0,1));
            // cout << "currRt_cp.at<double>(0,2) = " << currRt_cp.at<double>(0,2) << endl;
            mpz_init_set_d(curr_02, currRt_cp.at<double>(0,2));
            // cout << "currRt_cp.at<double>(0,3) = " << currRt_cp.at<double>(0,3) << endl;
            mpz_init_set_d(curr_03, currRt_cp.at<double>(0,3));
            // cout << "currRt_cp.at<double>(1,0) = " << currRt_cp.at<double>(1,0) << endl;
            mpz_init_set_d(curr_10, currRt_cp.at<double>(1,0));
            // cout << "currRt_cp.at<double>(1,1) = " << currRt_cp.at<double>(1,1) << endl;
            mpz_init_set_d(curr_11, currRt_cp.at<double>(1,1));
            // cout << "currRt_cp.at<double>(1,2) = " << currRt_cp.at<double>(1,2) << endl;
            mpz_init_set_d(curr_12, currRt_cp.at<double>(1,2));
            // cout << "currRt_cp.at<double>(1,3) = " << currRt_cp.at<double>(1,3) << endl;
            mpz_init_set_d(curr_13, currRt_cp.at<double>(1,3));
            // cout << "currRt_cp.at<double>(2,0) = " << currRt_cp.at<double>(2,0) << endl;
            mpz_init_set_d(curr_20, currRt_cp.at<double>(2,0));
            // cout << "currRt_cp.at<double>(2,1) = " << currRt_cp.at<double>(2,1) << endl;
            ...
            if (iter >= n_of_f) {
                cout << "Direct calculate " << iter - n_of_f << ":" << endl;
            }
            else {
                cout << "Feature calculate " << iter << ":" << endl;
            }
